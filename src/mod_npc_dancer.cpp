...
static uint64 DancerTip[5] = { 10000, 50000, 100000, 250000, 500000 };
...
public:
    ...
    void OnBeforeConfigLoad(bool /*reload*/) override
    {
        ...
        DancerTip[0] = sConfigMgr->GetOption<uint64>("Dancer.Tip1", 10000);
        DancerTip[1] = sConfigMgr->GetOption<uint64>("Dancer.Tip2", 50000);
        DancerTip[2] = sConfigMgr->GetOption<uint64>("Dancer.Tip3", 100000);
        DancerTip[3] = sConfigMgr->GetOption<uint64>("Dancer.Tip4", 250000);
        DancerTip[4] = sConfigMgr->GetOption<uint64>("Dancer.Tip5", 500000);
    }
};
